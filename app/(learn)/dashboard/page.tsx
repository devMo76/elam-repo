...
export default async function DashboardPage({ searchParams }: DashboardPageProps) {
  ...
  const courses = await getLearnerCourseProgress();
  ...
  return <PublicShell><main className="roleLanding"><h1>مرحبًا {viewer.fullName}</h1><p>ستظهر هنا المواد المسجل فيها وتقدمك الدراسي.</p></main></PublicShell>;
}
